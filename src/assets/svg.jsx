export const notificationIcon = (height, stroke, fill) => { return (
	<svg height={height} fill={fill} stroke={stroke || fill}
...
export const ellipses = (height, fill, stroke) => { return (
	<svg height={height} fill={fill} stroke={stroke || fill}
		viewBox="0 0 24 30" strokeWidth="2" strokeLinecap="round"
		strokeLinejoin="round" xmlns="http://www.w3.org/2000/svg">

		<circle className="c" cx="12" cy="3" r="2"></circle>
		<circle className="c" cx="12" cy="15" r="2"></circle>
		<circle className="c" cx="12" cy="27" r="2"></circle>
	</svg> )
}

export const noImg = (height='2em', fill='black', text='No Image', textColor='white') => {
	return (
		...
		viewBox="0 0 20 20"
			...
			<text x="50%" y="60%" fontSize="15%" fontFamily="sans-serif"
...
export const weather = {
	get: function(param) {return param}
}